                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <label for="user-id">Nom Complet</label>
                                    <input type="text" name="name" class="form-control" placeholder="Enter Full Name">
                                </div>                
                                
                                <div class="form-group">
                                    <label for="phone">Numero Contact </label>
                                    <input type="number" name="phone"  class="form-control" placeholder="Enter Phone" maxlength="10">
                                </div>

                                <div class="form-group">
                                    <label for="about-me">Vos réactions</label>
                            ...
                            <div class="col-lg-5 col-md-12">
                                ...
                                <div class="user-info mt-md-50"> <img src="admin/user/<?php echo $row['6'];?>" alt="userimage">
                                    ...
                                    <div class="font-18">
                                        <div class="mb-1 text-capitalize"><b>Nom Complet:</b> <?php echo $row['1'];?></div>
