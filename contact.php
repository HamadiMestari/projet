...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="full-row">
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white"> 27, rue Ingram, Paris</span> <br>
										<span class="text-white"> 27, rue Ingram, Paris</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+33 666-666-6666</span>
										<span class="text-white">+33 666-666-6666 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">helpline@airbnb.com</span>
										<span class="text-white">helpline@airbnb.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
							...
							<div class="col-md-12">
								<form class="w-100" action="#" method="post">
									<div class="row">
										...
										<button type="submit" value="send message" name="send" class="btn btn-success">Envoyer Message</button>
									</div>
								</form>
							</div>
						</div>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2783.8728223308544!2d4.823306376670607!3d45.753695514075936!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47f4ebb293c8a89f%3A0x3c1c834e5bc65b89!2sH%C3%B4tel%20Vaubecour!5e0!3m2!1sen!2sma!4v1686833352242!5m2!1sen!2sma" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
