    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Détail de la propriété</b></h2>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Accueil</a></li>
                                <li class="breadcrumb-item active">Détail de la propriété</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    ...
                                    <li><span class="text-secondary"><?php echo $row['6'];?></span> Chambre à coucher</li>
                                    <li><span class="text-secondary"><?php echo $row['7'];?></span> Salle de bains</li>
                                    <li><span class="text-secondary"><?php echo $row['8'];?></span> Balcon</li>
                                    <li><span class="text-secondary"><?php echo $row['10'];?></span> Entrée</li>
