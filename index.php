                            ...
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-success w-100">Rechercher une propriété</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Il s'agit d'un texte factice pour remplir les espaces. Juste quelques mots au hasard...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="sale bg-success text-white text-capitalize">Pour <?php echo $row['5'];?></div>
                                                <div class="price text-primary"><b><?php echo $row['13'];?> DH </b><span class="text-white"><?php echo $row['12'];?> Sqft</span></div>
                                            </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Il s'agit d'un texte factice pour remplir les espaces. Ceci est juste un texte factice pour remplir les espaces vides.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
