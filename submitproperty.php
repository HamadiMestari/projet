									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Type Vente </label>
													<div class="col-lg-9">
										...
										<div class="form-group row">
											...
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												...
												<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Âge de la propriété : </span>10 Qns</li>
														...
														<li class="mb-3"><span class="text-secondary font-weight-bold">GYM : </span>Oui</li>
														</ul>
													</div>
													<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Type : </span>Appartement</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Securit2 : </span>Oui</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Capacité de restauration : </span>10 Personnes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Église/Temple  : </span>Non</li>
