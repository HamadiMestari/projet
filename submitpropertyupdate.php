...
if(isset($_POST['add']))
{
	...
	$sql = "Propriété mise à jour SET title= '{$title}', pcontent= '{$content}', type='{$ptype}', bhk='{$bhk}', stype='{$stype}',
    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Propriété mise à jour</h2>
                        </div>
					</div>
									...
									<h5 class="text-secondary">Informations de base</h5><hr>
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Entrée</label>
													<div class="col-lg-9">
										...
										<div class="row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="floor">
															...
															<option value="1st Floor">1st étage</option>
															<option value="2nd Floor">2nd étage</option>
															<option value="3rd Floor">3rd étage</option>
															<option value="4th Floor">4th étage</option>
															<option value="5th Floor">5th étage</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Total étage</label>
													<div class="col-lg-9">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
											<p class="alert alert-danger">* Important Veuillez ne pas supprimer le contenu ci-dessous uniquement Modifier <b>Oui </b> Ou <b>Non</b> ou Détails et ne pas ajouter plus de détails</p>
										...
										<div class="row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control"  required name="status">
															...
															<option value="sold out">Solder</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Basement étage Plan Image</label>
													<div class="col-lg-9">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">étage Plan Image</label>
													<div class="col-lg-9">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Ground étage Plan Image</label>
													<div class="col-lg-9">
